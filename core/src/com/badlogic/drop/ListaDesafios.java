...
public class ListaDesafios extends Lista<String> {
    ...
    public void adicionarElementos() {
        ...
        lista.add("Acertar todos redíduos do tipo papel");
        lista.add("Acertar todos redíduos do tipo vidro");
        lista.add("Acertar todos redíduos do tipo plástico");
        lista.add("Acertar todos redíduos do tipo organico");
